            ...
            for learning_rate in l_r:
                ...
                for epoch in range(num_epochs):
                    ...
                    for l in range(0, len(reply_data), batch_size):
                        ...
                        print(f'{learning_rate} - {target_update} - {state_size} - {batch_size} --- {l}')
                ...
                torch.save(policy_net.state_dict(), embedding_n_results_path+ f'models/parameters_study/smorl_qlearning_1_movies_{learning_rate}_{target_update}_{state_size}_{batch_size}.pth')
                torch.save(target_net.state_dict(), embedding_n_results_path+ f'models/parameters_study/smorl_qlearning_2_movies_{learning_rate}_{target_update}_{state_size}_{batch_size}.pth')

                torch.save(policy_choice.state_dict(), embedding_n_results_path+ f'models/parameters_study/smorl_attr_1_movies_{learning_rate}_{target_update}_{state_size}_{batch_size}.pth')
                torch.save(target_choice.state_dict(), embedding_n_results_path+ f'models/parameters_study/smorl_attr_2_movies_{learning_rate}_{target_update}_{state_size}_{batch_size}.pth')